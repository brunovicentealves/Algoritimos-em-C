...
LISTA* no = (LISTA *)malloc(sizeof (LISTA));
 ...
 void inverter(LISTA **l){
 LISTA *fim, *inicio_lista, *proximo_lista;
      if (*l != NULL)
      {
          fim = NULL;
          ...
          proximo_lista = inicio_lista->prox;
          do
          {
              inicio_lista->prox = fim;
              
              fim = inicio_lista;
              
               inicio_lista = proximo_lista;
               
               if (proximo_lista != NULL) proximo_lista = proximo_lista->prox;
           }
